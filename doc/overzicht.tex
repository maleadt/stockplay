...
\emph{Ter illustratie:} ons project bevat volgens \emph{StatSVN}  meer dan 64145 lijnen code, waarbij enkel de zelfgemaakte bestanden in rekening werden genomen (geen gecompileerde klassen, geen externe libraries, word documenten, presentaties, afbeeldingen, enzovoort).
