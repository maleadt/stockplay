...
Het spel eindigt op 31 mei 2010, waarna een eindklassement wordt opgemaakt. De koersen op de website worden niet meer geÃ¼pdatet, en er kunnen ook geen transacties meer gedaan worden. Gebruikers kunnen wel nog steeds authenticeren op de website om statistieken van hun spelverloop te raadplegen.
...
\end{enumerate}
\paragraph{Alternatieve scenarioâ€™s}
...
\paragraph{Postcondities} De gebruiker was ingelogd, geregistreerd of was voldoende geÃ¯nformeerd over het spel.
...
\paragraph{Business rules}Het is op dit gedeelte van de site dat de surfer en potentiÃ«le speler overtuigd moet worden om actief mee te spelen.
...
\begin{enumerate}
 ...
 \item Speler is voldoende geÃ¯nformeerd
\end{enumerate}
...
\paragraph{Actoren} De speler bekijkt het portfolio. De huidige waarde hangt af van de reÃ«le beursevolutie (de scappers volgen deze evolutie).
...
\begin{enumerate}
 ...
 \item De applicatie toont een paneel met de status van de servers samen met mogelijk acties die de administrator kan ondernemen.
...
\begin{enumerate}
 ...
 \item De administrator kiest een gebruiker uit de tabel en de voert actie “Gebruiker bewerken” uit.
...
\begin{enumerate}
 ...
 \item De administrator selecteert één of meerdere effecten die hij wil aanpassen.
 \item De actie “Effect(en) verbergen” of “Effect(en) schorsen” wordt gekozen.
 \item De veranderingen worden doorgestuurd naar de backend en deze past ze aan in de databank.
\end{enumerate}
\paragraph{Alternatieve Scenario's}
\begin{enumerate}
