...
\subsection{Algemene zaken}
\label{sec:handl:admin:algemeen}

\subsubsection{Verifi\"eren connectiviteit}
...
\subsection{Beheer van effecten}
...
\subsection{Beheer van gebruikers}
...
\subsubsection{Gebruiker toevoegen}
...
\subsubsection{Gebruiker bewerken}
...
\section{Handleiding webapplicatie}
...
\subsection{Overzicht van effecten - opvragen van details}
...
\subsection{Aankopen van effecten}
...
\begin{figure}[h!]
	...
	\caption{Waarschuwingsvenster verbinding}
