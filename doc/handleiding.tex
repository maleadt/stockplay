...
\subsection{Verifi\"eren connectiviteit}
...
\begin{figure}[h!]
	\centering
		\includegraphics[width=\textwidth]{images/handleiding/administratie/verbindingsfout}
	\caption{Aanmeldformulier}
...
\begin{figure}[h!]
	\centering
		\includegraphics[width=\textwidth]{images/handleiding/administratie/login}
	\caption{Aanmeldformulier}
...
\begin{figure}[h!]
	\centering
		\includegraphics[width=\textwidth]{images/handleiding/administratie/login-failure}
	\caption{Aanmeldformulier}
...
\begin{figure}[h!]
	\centering
		\includegraphics[width=\textwidth]{images/handleiding/administratie/gebruikers-nieuw}
	\caption{Een nieuwe gebruiker aanmaken}
		\label{fig:handl:admin:gebruikers-nieuw}
\end{figure}

\subsection{Gebruiker bewerken}
...
\begin{figure}[h!]
	\centering
		\includegraphics[width=\textwidth]{images/handleiding/administratie/gebruikers-edit}
...
\begin{figure}[h!]
	\centering
		\includegraphics[width=\textwidth]{images/handleiding/administratie/gebruikers-edit-cash}
