...
Nu vastligt hoe de data in een uniforme en gestructureerde wijze opgeslaan wordt, is het duidelijk dat de data opgedeelt kan worden in twee categorie\"en: presistente en variabele data.
