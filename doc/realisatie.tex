...
Een transactie is ook niet altijd mogelijk: als een speler te weinig cash in huis heeft om te kopen, of te weinig effecten om te kunnen verkopen, dan kan een transactie niet doorgaan, dit wordt door de volgende trigger gecontroleerd:
...
De verandering in punten bij een speler wordt geregistreerd in de tabel ``pointtransactions``, dat laat toe om een meer verfijnde klassementen op te stellen (dagklassement, weekklassement, maandklassement, ...). Het totale aantal punten wordt met behulp van onderstaande trigger geupdated in de ``users``-tabel:
