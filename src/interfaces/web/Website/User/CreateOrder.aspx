<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreateOrder.aspx.cs" Inherits="User_CreateOrder"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    ...
    <p runat="server"><asp:Literal runat="server" Text="<%$ Resources:Para1 %>" /> <b id="Security" runat="server"></b>.</p>
    <p runat="server"><asp:Literal runat="server" Text="<%$ Resources:Para2 %>" /> <b id="Quote" runat="server"></b>.</p>
    
    <p><asp:Literal runat="server" Text="<%$ Resources:Para3 %>" /> <b id="Cash" runat="server"></b></p>
    
    <p>
        <asp:Literal runat="server" Text="<%$ Resources:Para4 %>" /> <asp:TextBox ID="txtAmount" runat="server" ValidationGroup="AmountValidation"></asp:TextBox> x 
    ...
    <p>
        ...
        <asp:RangeValidator ID="RangeValidator2" runat="server" ValidationGroup="AmountValidation" ControlToValidate="txtQuote"
         ...
         <asp:Label ID="ErrorLabel" meta:resourcekey="LabelError" ForeColor="Red" runat="server" Visible="false" />
    </p>
    ...
    <p>
        <asp:Button ID="btnConfirm" meta:resourcekey="Confirm" runat="server" OnClick="btnConfirm_Click" ValidationGroup="AmountValidation" Visible="false" />
