 ...
 * StockPlay - Filter converter voor een groter dan of gelijk aan conditie.
 *
...
public class ConditionGreaterConverter extends ConditionGreater {

    //
    // Construction
    //

    public ConditionGreaterConverter(ConditionGreater iObject) {
        super(iObject);
    }
